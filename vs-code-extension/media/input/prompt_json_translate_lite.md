...
- Use type "grammar" for actual text changes. Use type "comment" only for note-only items when you cannot safely edit (then corrected = original, explanation is a brief note).
